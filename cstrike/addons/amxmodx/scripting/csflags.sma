...
team_win(team) 
{
	...
	*/
	...
	{
		if (CsTeams:(team + 1) == CS_TEAM_CT)
			rg_round_end(3.0, WINSTATUS_CTS, ROUND_CTS_WIN, _, _, .trigger = true);
		else
			rg_round_end(3.0, WINSTATUS_TERRORISTS, ROUND_TERRORISTS_WIN, _, _, .trigger = true);
//		move_to_spawn()
	}
